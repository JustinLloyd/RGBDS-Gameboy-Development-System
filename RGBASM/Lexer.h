...
extern void strltrim(char *s) ;
extern void strrtrim(char *s) ;
extern void MakeUniqueSection(char *dest) ;

extern void ValidateBankNumber(int bankNumber) ;
extern int VerifyBankNumber(int bankNumber) ;
extern void ValidateBankAddress(long bankAddress) ;
extern int VerifyBankAddress(long bankAddress) ;
extern void ValidateSectionName(char *sectionName) ;
extern int VerifySectionName(char *sectionName) ;
